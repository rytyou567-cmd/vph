/**
 * libgs.js (Emscripten Glue Code)
 * 
 * ROLE:
 * This file is the auto-generated JavaScript bridge (Glue Code) produced by Emscripten 
 * when compiling Ghostscript C source code to WebAssembly (WASM).
 * 
 * RESPONSIBILITIES:
 * 1. WASM LOADING: Fetches and compiles the `libgs.wasm` binary.
 * 2. MEMORY MANAGEMENT: Manages the Linear Memory (HEAP8, HEAP32) shared between JS and WASM.
 * 3. VIRTUAL FILE SYSTEM (MEMFS): Simulates a file system in memory (`FS` object) so Ghostscript 
 *    can read/write files like it's on a real OS (required for input PDF -> output PDF processing).
 * 4. CLI EMULATION: Provides `callMain()` to invoke Ghostscript with command-line arguments.
 * 
 * CORE INTERFACE (Accessed via `Module`):
 * - `Module.callMain(args)`: Executes the Ghostscript main loop with string arguments.
 *   Example: `Module.callMain(['-sDEVICE=pdfwrite', '-o', 'out.pdf', 'in.pdf'])`
 * - `Module.FS`: The Virtual File System API.
 *   - `FS.writeFile(path, data)`: Writes Uint8Array data to the virtual disk.
 *   - `FS.readFile(path)`: Reads data back from the virtual disk.
 * - `Module.locateFile(path)`: Hook to tell the loader where to find `.wasm` files.
 * 
 * NOTE: 
 * This file is largely machine-generated and minified. Manual editing is discouraged 
 * except for configuration hooks at the very top or bottom.
 */
...
var Module = (() => {
  ...
  return (
    function (Module) {
      ...
      Object.getOwnPropertyDescriptor(d.ready, "_main") || (Object.defineProperty(d.ready, "_main", {
      ...
      }), Object.defineProperty(d.ready, "_main", {
      ...
      Object.getOwnPropertyDescriptor(d.ready, "___stdio_exit") || (Object.defineProperty(d.ready, "___stdio_exit", {
        configurable: !0, get: function () {
      ...
      }), Object.defineProperty(d.ready, "___stdio_exit", {
        configurable: !0, set: function () {
      ...
      Object.getOwnPropertyDescriptor(d.ready, "onRuntimeInitialized") || (Object.defineProperty(d.ready, "onRuntimeInitialized", {
        configurable: !0, get: function () {
      ...
      }), Object.defineProperty(d.ready, "onRuntimeInitialized", {
        configurable: !0, set: function () {
      ...
      var ra;
      function A(a, b) {
        Object.getOwnPropertyDescriptor(d, a) || Object.defineProperty(d, a, {
          configurable: !0, get: function () {
      ...
      var yb = {}, S = {
        ...
        Ea: 16895, la: 33279, Ua: null, m: function (a) {
          function b(g) {
            g = g.split("/");
        ...
        root: null, qa: [], fb: {}, streams: [], Wb: 1, L: null, eb: "/", va: !1, Na: !0, g: null, Ka: {}, Jb: null, ta: 0, o: (a, b = {}) => {
          a = ob(Q.cwd(), a);
          if (!a) {
      ...
      var hc = {
        __assert_fail: function (a, b, c, e) {
      ...
      vc();
      Object.assign(Q, {
        init: Q.Y, mkdir: Q.mkdir, mount: Q.m, chdir: Q.chdir, writeFile: Q.writeFile, readFile: Q.readFile, createLazyFile: Q.Eb, setIgnorePermissions: function (a) {
          Q.Na = a;
        },
      });
